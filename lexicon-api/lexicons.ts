        ...
        record: {
          ...
          properties: {
            ...
            result: {
              ...
              refs: [
                'lex:app.gainforest.dwc.measurement#floraMeasurement',
                'lex:app.gainforest.dwc.measurement#faunaMeasurement',
                'lex:app.gainforest.dwc.measurement#genericMeasurement',
              ],
              closed: false,
            },
            measuredBy: {
      ...
      floraMeasurement: {
        ...
        properties: {
          ...
          additionalMeasurements: {
            ...
            items: {
              type: 'ref',
              ref: 'lex:app.gainforest.dwc.measurement#measurementEntry',
            },
          },
        },
      },
...
export const ids = {
  ...
  AppGainforestGbifDataset: 'app.gainforest.gbif.dataset',
  AppGainforestOrganizationDefaultSite:
