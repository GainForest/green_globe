  ...
  return (
    ...
    >
      <Link
        ...
        target="_blank"
      >
        <button className="text-left flex items-start gap-4 border border-border rounded-lg p-4 bg-background/50">
              ...
              {work && (
                <div className="text-xs text-muted-foreground mt-2 flex items-center gap-1.5">
                  ...
                  <span className="font-bold">
                    {formatDate(Number(work.from))} -{" "}
                    {formatDate(Number(work.to))}
                  </span>
                </div>
              )}
