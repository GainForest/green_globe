...
import useOrganizationInfo from "../ProjectOverlay/hooks/useOrganizationInfo";
...
const SearchOverlay = () => {
  ...
  const { isOrganizationInfoPending, organizationInfoError } =
    useOrganizationInfo(projectId ?? undefined);
